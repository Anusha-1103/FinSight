    ...
    static getAiClient() {
        if (env_1.env.GEMINI_API_KEY) {
            try {
                ...
                logger_utils_1.logger.warn('[Gemini AI] Initialization failed, using intelligent analytical engine fallback:', err);
            }
        }
        return null;
    }
...
{"merchantName": "...", "totalAmount": 45.99, "dateExtracted": "2026-08-01", "category": "Groceries", "confidenceScore": 0.98}`;
                ...
                logger_utils_1.logger.warn('[Gemini OCR] OCR image parsing failed, executing intelligent text/OCR fallback:', err);
            }
        }
