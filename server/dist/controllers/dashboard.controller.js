...
const financialHealth_service_1 = require("../services/financialHealth.service");
class DashboardController {
    static async getSummary(req, res, next) {
        try {
            ...
            const [accounts, activeAccountsCount, incomeAggregate, expenseAggregate, latestTransactions, largestExpense, largestIncome, categoryExpenses, subscriptions, budgets, goals, notifications, healthScore,] = await Promise.all([
                db_1.prisma.account.findMany({ where: { userId }, orderBy: { createdAt: 'asc' } }),
                db_1.prisma.account.count({ where: { userId } }),
                ...
                financialHealth_service_1.FinancialHealthService.calculateHealthScore(userId),
            ]);
            ...
            const categoryDetails = await db_1.prisma.category.findMany({
            ...
            const heatmapObj = { Sun: 0, Mon: 0, Tue: 0, Wed: 0, Thu: 0, Fri: 0, Sat: 0 };
